            ...
            <div
                className="sidebar-opened-w-modal">
                {
                    this.props.editingMode ?
                        ...
                        :
                        <ViewerAnnotationCards editingMode={this.props.editingMode} annotations={this.props.annotations} selectedProject={this.props.selectedProject} openFullAnnotationView={(annotation) => { this.props.openFullAnnotationView(annotation) }}/>
                }
            </div>
        )
    }
